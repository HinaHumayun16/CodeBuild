<powershell>
 ...
 $env:CHEF_SERVER_NAME = "chef-server-g" # Name of your Chef Server
 $env:CHEF_SERVER_ENDPOINT = "chef-server-g-zgizbsbmdihrypai.us-east-1.opsworks-cm.io" # FQDN of your Chef Server
