...
CHEF_SERVER_NAME="chef-server-g" # The name of your Chef Server
CHEF_SERVER_ENDPOINT="chef-server-g-zgizbsbmdihrypai.us-east-1.opsworks-cm.io" # The FQDN of your Chef Server
